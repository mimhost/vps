...
iptables -t nat -A POSTROUTING -o $PUBLIC_INET -j SNAT --to-source 124.217.230.192
iptables -t nat -A POSTROUTING -o venet0 -j SNAT --to-source 124.217.230.192
iptables -t nat -A POSTROUTING -s 10.200.0.0/16 -o venet0 -j SNAT --to-source 124.217.230.192
iptables -t nat -A POSTROUTING -s 10.201.0.0/16 -o venet0 -j SNAT --to-source 124.217.230.192
EOFipt
