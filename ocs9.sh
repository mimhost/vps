...
function InstAsk(){
 ...
 read -p "Password: " -e -i datovpn DatabasePass
 echo ""
 ...
 read -p " Database Name: " -e -i datoocs DatabaseName
 echo ""
...
function InstPanel(){
 ...
 wget -O /home/panel/html/datovpn.zip https://github.com/Apeachsan91/vps/raw/master/datovpn.zip
 sleep 2
...
echo "" | tee -a log-install.txt
echo "OCS Script Installer by DatoVPN"  | tee -a log-install.txt
echo "" | tee -a log-install.txt
